 ...
 */
	...
	_074("074","Structure Check","PROPERTY SEGMENT MUST EXIST WITH THIS OFFENSE","An Item Section must be submitted when Data Element 6 (UCR Offense Code) contains an offense of Kidnapping/Abduction, Crimes Against Property, Drug/Narcotic Offenses, or Gambling Offenses."),
	...
	_080("080","Structure Check","CRIMES AGAINST SOCIETY CAN HAVE ONLY ONE SOCIETY/PUBLIC VICTIM","The Group A Incident Report submission contains only offense(s) that are Crimes Against Society. When this is so, Data Element 25 (Type of Victim) must be S = Society/Public, and only one victim may be submitted.\n"
			+ "Must be G = Government for the following offenses:\n"
			+ "26H = Money Laundering*\n"
			+ "521 = National Firearm Act 1934* 522 = Weapons of Mass Destruction* 526 = Explosives*\n"
			+ "58A = Import Violations*\n"
			+ "58B = Export Violations*\n"
			+ "61A = Federal Liquor Offenses*\n"
			+ "61B = Federal Tobacco Offenses* 620 = Wildlife Trafficking*\n"
			+ "*Denotes offenses for federal and tribal LEA reporting only"),
 ...
 */
	...
	_360("360","Property Segment","PROPERTY LOSS (14) MUST BE 5 WITH AN OFFENSE CODE OF 240 FOR DATA TO BE ENTERED","Data Element 19 (Number of Recovered Motor Vehicles) was entered. However, Data Element 14 (Type Property Loss/Etc.) Recovered was not entered, and/or Data Element 6 (UCR Offense Code) of 240 = Motor Vehicle Theft was not entered, and/or Data Element 7 (Offense Attempted/Completed) was Attempted.\n"
			+ "The exception to this rule is when recovered property is reported for a pre-NIBRS incident. In this case, Property will contain I = Incident Report, but the data value in Data Element 2 (Incident Number) will not match an incident already on file in the national UCR database. The property will be processed but used only for SRS purposes and will not be included in the agency’s NIBRS figures."),
 ...
 */
	...
	_481("481","Victim Segment","VICTIM'S AGE IS 18 OR OVER FOR STATUTORY RAPE OFFENSE","Data Element 26 (Age of Victim) should be under 18 when Data Element 24 (Victim Connected to UCR Offense Code) is 36B=Statutory Rape."),
 ...
 * Added in 2019.2	
 */
	_485("485","Victim Segment","OFFENDER NUMBER TO BE RELATED CANNOT BE '00' FOR THIS OFFENSE","(Offender Number to be Related) cannot be 00 = Unknown when Data Element 24 (Victim Connected to UCR Offense Code) is 360 = Failure to Register as a Sex Offender*.\n"
			+ "*Denotes offenses for federal and tribal LEA reporting only"),
/**
 * 490 not implemented	
 */
 ...
 */
	...
	_559("559","Offender Segment","OFFENDER DATA MUST BE PRESENT IF OFFENSE CODE IS 09C = JUSTIFIABLE HOMICIDE OR 360 = FAILURE TO REGISTER AS A SEX OFFENDER*","The incident was submitted with Data Element 6 (UCR Offense Code) value of 09C = Justifiable Homicide or 360 = Failure to Register as a Sex Offender*, but unknown information was submitted for all the offender(s). At least one of the offenders must have known information for age, sex, and race.\n"
			+ "*Denotes offenses for federal and tribal LEA reporting only"),
